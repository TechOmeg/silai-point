...
<head>
    <meta charset="utf-8" />
    <title>All Fabrics | Silai Point </title>
...
<tr>
    ...
    <td class="text-center">
        ...
        <!-- EDIT -->
        <a href="{{ route('edit.fabric', $fabric->id) }}"
        ...
        <!-- DELETE -->
        <form action="{{ route('delete.fabric', $fabric->id) }}"
              method="POST"
              class="d-inline">
            ...
            <button type="submit"
                    onclick="return confirm('Delete this fabric?')"
