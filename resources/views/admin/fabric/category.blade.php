...
<head>
    <meta charset="utf-8" />
    <title>Fabric Categories | Silai Point </title>
...
<body>
    ...
    <!-- Left Side - Add Fabric Category Form -->
    <div class="col-xl-4">
        <div class="card">
            <div class="card-header border-bottom border-dashed d-flex align-items-center">
                <h4 class="header-title mb-0">Add Fabric Category</h4>
            </div>

            <div class="card-body">

                <form action="{{ route('fabric-category.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
    ...
    <!-- Right Side - Fabric Category List -->
    <div class="col-xl-8">
        <div class="card">
            <div class="card-header border-bottom border-dashed d-flex align-items-center justify-content-between">
                <h4 class="header-title mb-0">Fabric Category List</h4>
            </div>
...
<a href="javascript:void(0);" 
   class="link-reset fs-20 p-1 text-primary"
...
<div class="modal fade" id="editModal{{ $category->id }}" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('fabric-category.update', $category->id) }}" 
                  method="POST" 
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Edit Fabric Category</h5>
                ...
                <div class="modal-body">
                    ...
                    <!-- Name -->
                    <div class="mb-3">
                        <label class="form-label text-start d-block">Category Name</label>
                    ...
                    <!-- Image -->
                    <div class="mb-3">
                        <label class="form-label text-start d-block">Image</label>
                        ...
                        <img src="{{ asset('uploads/categories/' . $category->image) }}" 
                             width="80"
                             class="mt-2 rounded text-start d-block">
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success">
                        Update Category
                                   ...
                                   <form action="{{ route('fabric-category.destroy', $category->id) }}" 
                                          method="POST"
                                          class="d-inline">
                                        ...
                                        <button type="submit"
                                                class="border-0 bg-transparent text-danger fs-20 p-1">
