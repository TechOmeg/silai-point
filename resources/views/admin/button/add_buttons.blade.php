...
<head>
    <meta charset="utf-8" />
    <title>Add Button | Silai Point </title>
        ...
        <div class="page-title-head d-flex align-items-center justify-content-between mb-4">
            <div>
                <h4 class="fs-18 fw-bold mb-0">
                    {{ isset($fabric) ? 'Edit Button' : 'Add Button' }}
                </h4>
            </div>
        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-header border-bottom border-dashed">
                        <h4 class="header-title mb-0">
                            {{ isset($fabric) ? 'Update Button Details' : 'Add New Button' }}
                        </h4>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ isset($button) ? route('update.button', $button->id) : route('store.button') }}"
      method="POST"
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="text" name="name" class="form-control"
                   value="{{ old('name', $button->name ?? '') }}">
        </div>

        <!-- CATEGORY -->
        <div class="col-md-6 mb-3">
            <label class="form-label">Button Category</label>
            <select name="button_category_id" class="form-select">
                <option value="">Select Category</option>
                @foreach($categories as $category)
                    <option value="{{ $category->id }}"
                        {{ old('button_category_id', $button->button_category_id ?? '') == $category->id ? 'selected' : '' }}>
                        {{ $category->name }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="text" name="material" class="form-control"
                   value="{{ old('material', $button->material ?? '') }}">
        </div>
        ...
        <div class="col-12 mb-3">
            ...
            <textarea name="description" rows="4" class="form-control">{{ old('description', $button->description ?? '') }}</textarea>
        </div>
        ...
        <div class="col-md-6 mb-3">
            ...
            <select name="status" class="form-select">
                <option value="1" {{ old('status', $button->status ?? 1) == 1 ? 'selected' : '' }}>Active</option>
                <option value="0" {{ old('status', $button->status ?? '') == 0 ? 'selected' : '' }}>Inactive</option>
            </select>
        </div>
        ...
        <div class="col-12">
            <button class="btn btn-primary">
                {{ isset($button) ? 'Update Button' : 'Add Button' }}
            </button>
        </div>
