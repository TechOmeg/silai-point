...
<head>
    <meta charset="utf-8" />
    <title>Dashboard | Silai Point</title>
                ...
                <div class="card border-0 shadow-sm overflow-hidden">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center gap-3 mt-3">
                            ...
                            <div class="avatar-md bg-warning rounded-circle d-flex align-items-center justify-content-center">
                                <i class="ti ti-currency-rupee text-white fs-24"></i>
                            </div>
                ...
                <div class="card border-0 shadow-sm overflow-hidden">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center gap-3 mt-3">
                            ...
                            <div class="avatar-md bg-danger rounded-circle d-flex align-items-center justify-content-center">
        ...
        <div class="row mt-4">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm text-center p-4">
                    ...
                    <div class="mb-3">
                        <i class="ti ti-shirt fs-48 text-primary"></i>
                    </div>

                    <h5>Add New Fabric</h5>

                    <a href="add-fabric.html"
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm text-center p-4">
                    ...
                    <div class="mb-3">
                        <i class="ti ti-circle-dot fs-48 text-warning"></i>
                    </div>

                    <h5>Add Buttons</h5>

                    <a href="add-buttons.html"
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm text-center p-4">
                    ...
                    <div class="mb-3">
                        <i class="ti ti-scissors fs-48 text-danger"></i>
                    </div>

                    <h5>Tailoring Types</h5>

                    <a href="add-tailoring.html"
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm text-center p-4">
                    ...
                    <div class="mb-3">
                        <i class="ti ti-ruler-measure fs-48 text-success"></i>
                    </div>
        ...
        <div class="page-container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-center text-md-start">
                    ...
                    © Silai Point - Custom Tailoring Platform
                </div>
