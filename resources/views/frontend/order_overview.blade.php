...
<!-- Mirrored from risingtheme.com/html/demo-suruchi-v1/suruchi/cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 May 2026 10:29:36 GMT -->
<head>
  <meta charset="utf-8">
  <title>Order Overview - Silai Point</title>
...
<!-- TITLE -->
<h2 class="measurement-title">
    Order Overview
</h2>

<p class="measurement-desc">
    Apni details confirm karein aur order finalize karein. Payment aur delivery details neeche available hain.
</p>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="measurement-group">
                <label>Name</label>
                <input type="text" name="customer_name" class="measurement-input" required>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="measurement-group">
                <label>Email</label>
                <input type="email" name="customer_email" class="measurement-input" required>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="measurement-group">
                <label>Phone</label>
                <input type="text" name="customer_phone" class="measurement-input" required>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="measurement-group">
                <label>Address</label>
                <textarea name="address" class="measurement-textarea" required></textarea>
            </div>
        </div>
...
<div class="measurement-step">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="measurement-group">
                <label>Silai Type</label>
                <select name="silai_type" class="measurement-input">
                    <option value="single">Single Silai - Rs.1999</option>
                    <option value="double">Double Silai - Rs.2999</option>
                </select>
            </div>
        </div>
...
<div class="measurement-step">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="measurement-group">
                <label>Standard Delivery (7 Days)</label>
        ...
        <div class="col-md-6">
            <div class="measurement-group">
                <label>Urgent Delivery (+ Extra Charges)</label>
                <input type="radio" name="delivery_type" value="urgent">
            </div>
        </div>

        <div class="col-md-6">
            <div class="measurement-group">
                <label>Select Delivery Date (Urgent Only)</label>
                <input type="date" name="delivery_date" class="measurement-input">
            </div>
        </div>
...
<div class="measurement-step">
    ...
    @if(session('cart') && count(session('cart')) > 0)
        ...
        @foreach(session('cart') as $id => $details)
            ...
            @php
                $price = $details['price_per_meter'] ?? 0;
                $qty   = $details['meter'] ?? 1;
                $total = $details['total_price'] ?? ($price * $qty);
...
<!-- SUBMIT -->
<button type="submit" class="measurement-btn">
...
@php
    ...
    if(session('cart')){
        foreach(session('cart') as $id => $details){
            ...
            $subtotal += ($details['total_price'] ?? ($price * $qty));
        }
    }
...
<div class="summary-box">
    <h5>Total</h5>
    <p><b>Rs. {{ number_format($total) }}</b></p>
</div>

<!-- BUTTON -->
<button type="button" class="measurement-btn">
    Apply Coupon
</button>
...
$("#measurementForm").submit(function(e){
    ...
    $.ajax({
        ...
        success:function(response){
            ...
            $("#overview-section").html(response.html);
