            ...
            <div class="container-fluid">
                <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                    ...
                    <div class="main__logo">
                        <h1 class="main__logo--title"><a class="main__logo--link" href="index.html"><img class="main__logo--img" src="{{ asset('assets/img/logo/logo.png') }}" alt="logo-img" height="50px" style="height:100px!important;"></a></h1>
                    </div>
