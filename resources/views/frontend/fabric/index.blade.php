...
<head>
  <meta charset="utf-8">
  <title>Fabrics - Silai Point</title>
...
.custom__breadcrumb{
    ...
    background:url('/assets/img/banner/fabrics_banner.png') center center/cover no-repeat;
}
...
@endforeach
                            ...
                            <div class="single__widget widget__bg">
                                ...
                                <div class="product__grid--inner">
                                    @foreach ($topRatedFabrics as $fabric)
                                    <div class="product__items product__items--grid d-flex align-items-center">
                                        <div class="product__items--grid__thumbnail position__relative">
                                            <a class="product__items--link" href="product-details.html">
                                                <img class="product__items--img product__primary--img" src="{{ asset('uploads/fabrics/' . $fabric->image) }}" alt="product-img">
                                                <img class="product__items--img product__secondary--img" src="{{ asset('uploads/fabrics/' . $fabric->image) }}" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__items--grid__content">
                                            <h3 class="product__items--content__title h4"><a href="product-details.html">{{ $fabric->name }}</a></h3>
                                            <div class="product__items--price">
                                                <span class="current__price">RS.{{ number_format($fabric->price, 2) }}</span>
                                                <span class="price__divided"></span>
                                                <span class="old__price">RS.{{ number_format($fabric->old_price, 2) }}</span>
                                            </div>
                            ...
                            <div class="single__widget widget__bg">
    <h2 class="widget__title h3">Fabric Brands</h2>

    <ul class="widget__tagcloud">
        <li class="widget__tagcloud--list">
            <a class="widget__tagcloud--link" href="#">Gul Ahmed</a>
        </li>

        <li class="widget__tagcloud--list">
            <a class="widget__tagcloud--link" href="#">Alkaram Studio</a>
        </li>

        <li class="widget__tagcloud--list">
            <a class="widget__tagcloud--link" href="#">Junaid Jamshed</a>
        </li>

        <li class="widget__tagcloud--list">
            <a class="widget__tagcloud--link" href="#">Bonanza Satrangi</a>
        </li>

        <li class="widget__tagcloud--list">
            <a class="widget__tagcloud--link" href="#">Khaadi</a>
        </li>

        <li class="widget__tagcloud--list">
            <a class="widget__tagcloud--link" href="#">Nishat Linen</a>
        </li>

        <li class="widget__tagcloud--list">
            <a class="widget__tagcloud--link" href="#">Sapphire</a>
        </li>

        <li class="widget__tagcloud--list">
            <a class="widget__tagcloud--link" href="#">ChenOne</a>
        </li>

        <li class="widget__tagcloud--list">
            <a class="widget__tagcloud--link" href="#">Bin Saeed</a>
        </li>

        <li class="widget__tagcloud--list">
            <a class="widget__tagcloud--link" href="#">Sitara Textile</a>
        </li>
    </ul>
</div>
                        </div>
        ...
        <ul class="pagination__wrapper d-flex align-items-center justify-content-center">
            ...
            @else
                <li class="pagination__list">
                    <a href="{{ $fabrics->previousPageUrl() }}" class="pagination__item--arrow link">
                        <i class="fa-solid fa-angle-left"></i>
                    </a>
                </li>
            @endif
            ...
            {{-- Pagination Numbers --}}
            @for ($i = 1; $i <= $fabrics->lastPage(); $i++)
                <li class="pagination__list">
                    <a href="{{ $fabrics->url($i) }}"
                       class="pagination__item {{ $fabrics->currentPage() == $i ? 'pagination__item--current' : 'link' }}">
                        {{ $i }}
                    </a>
                </li>
            @endfor
            ...
            {{-- Next Page Link --}}
            @if ($fabrics->hasMorePages())
                <li class="pagination__list">
                    <a href="{{ $fabrics->nextPageUrl() }}" class="pagination__item--arrow link">
