...
<!-- Mirrored from risingtheme.com/html/demo-suruchi-v1/suruchi/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 May 2026 10:28:46 GMT -->
<head>
  <meta charset="utf-8">
        ...
        <div class="hero__slider--wrapper swiper-wrapper">
            ...
            <div class="swiper-slide">
                <div class="hero__slider--items">
                    <img src="assets/img/slider/slide.png" alt="Slider Image 1" style="width:100%; height:auto; display:block;">
                </div>
            </div>
            ...
            <div class="swiper-slide">
                <div class="hero__slider--items">
                    <img src="assets/img/slider/slide-1.png" alt="Slider Image 2" style="width:100%; height:auto; display:block;">
                </div>
            </div>
            ...
            <div class="swiper-slide">
                <div class="hero__slider--items">
                    <img src="assets/img/slider/slide-3.png" alt="Slider Image 3" style="width:100%; height:auto; display:block;">
                </div>
            </div>
...
<section class="banner__section section--padding color-scheme-2">
    
    <div class="section__heading text-center mb-35">
        <h2 class="section__heading--maintitle style2">
            Shop by Categories
        </h2>
    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="custom-category-banner">
            <img src="assets/img/banner/slider1.png" 
                 alt="Silai Point Categories Banner">
        </div>
...
<section class="category__section section--padding pt-0">
    <div class="container-fluid">

        <div class="section__heading text-center mb-35">
            <h2 class="section__heading--maintitle style2">Fabric Categories</h2>
        </div>

        <div class="swiper fabricCategorySlider">
            <div class="swiper-wrapper">

                @foreach($fabricCategories as $category)
                    <div class="swiper-slide">
                        <div class="category__card text-center">
...
<section class="product__section section--padding pt-0">
    <div class="container-fluid">
        ...
        <div class="section__heading text-center mb-35">
            <h2 class="section__heading--maintitle style2">Fabrics Collection</h2>
        </div>
                ...
                <div class="col mb-30">
                    ...
                    <div class="product__items">
                        ...
                        <div class="product__items--thumbnail">
                            ...
                            <a class="product__items--link" href="{{ route('fabric.show', $fabric->id) }}">
                                <img class="product__items--img product__primary--img"
                                     src="{{ asset('uploads/fabrics/' . $fabric->image) }}"
                                     alt="{{ $fabric->name }}">
                        ...
                        <div class="product__items--content text-center">
                            ...
                            <h3 class="product__items--content__title h4">
                                <a href="{{ route('fabric.show', $fabric->id) }}">
                                    {{ $fabric->name }}
                                </a>
                            </h3>
...
<section class="category__section section--padding pt-0">
    <div class="container-fluid">
        ...
        <div class="section__heading text-center mb-35">
            <h2 class="section__heading--maintitle style2">Button Categories</h2>
        </div>

        <div class="swiper buttonCategorySlider">
            <div class="swiper-wrapper">

                @foreach($buttonCategories as $category)
                    <div class="swiper-slide">
                        ...
                        <div class="category__card text-center">
                            ...
                            <a href="#">
                                ...
                                <div class="category__img">
                                    <img src="{{ asset('uploads/button_categories/' . $category->image) }}" alt="{{ $category->name }}">
                                </div>
...
{{-- ================= BUTTON PRODUCTS SECTION ================= --}}
<section class="product__section section--padding pt-0">
    <div class="container-fluid">

        <div class="section__heading text-center mb-35">
            <h2 class="section__heading--maintitle style2">Buttons Collection</h2>
        </div>
                ...
                <div class="col mb-30">
                    ...
                    <div class="product__items">
                        ...
                        <div class="product__items--thumbnail">
                            ...
                            <a class="product__items--link" href="{{ route('button.show', $button->id) }}">
                                <img class="product__items--img product__primary--img"
                                     src="{{ asset('uploads/buttons/' . $button->image) }}"
                                     alt="{{ $button->name }}">
                        ...
                        <div class="product__items--content text-center">
                            ...
                            <h3 class="product__items--content__title h4">
                                <a href="{{ route('button.show', $button->id) }}">
                                    {{ $button->name }}
                                </a>
                            </h3>
...
/* IMPORTANT FIX */
.fabricCategorySlider,
.fabricProductSlider,
.buttonCategorySlider,
.buttonProductSlider{
    width: 100%;
    overflow: hidden;
}

.fabricCategorySlider .swiper-wrapper,
.fabricProductSlider .swiper-wrapper,
.buttonCategorySlider .swiper-wrapper,
.buttonProductSlider .swiper-wrapper{
    align-items: stretch;
}

.fabricCategorySlider .swiper-slide,
.fabricProductSlider .swiper-slide,
.buttonCategorySlider .swiper-slide,
.buttonProductSlider .swiper-slide{
    height: auto;
}
...
<!-- Start Banner 1 -->
<section class="banner__section section--padding pt-0 color-scheme-2">
    <div class="container-fluid p-0">
        <div class="banner__items position__relative">
            <a class="banner__items--thumbnail" href="shop.html">
                <img class="banner__items--thumbnail__img w-100"
                     src="assets/img/banner/web-banner.png"
                     alt="banner-img">
            </a>
        </div>
    </div>
...
<section class="banner__section section--padding pt-0 color-scheme-2">
    <div class="container-fluid p-0">
        <div class="banner__items position__relative">
            <a class="banner__items--thumbnail" href="shop.html">
                <img class="banner__items--thumbnail__img w-100"
                     src="assets/img/banner/offer_banner.png"
                     alt="banner-img">
            </a>
        </div>
    </div>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // FABRIC CATEGORY
    new Swiper(".fabricCategorySlider", sliderSettings);

    // FABRIC PRODUCTS
    new Swiper(".fabricProductSlider", sliderSettings);

    // BUTTON CATEGORY
    new Swiper(".buttonCategorySlider", sliderSettings);

    // BUTTON PRODUCTS
    new Swiper(".buttonProductSlider", sliderSettings);
...
<!-- Mirrored from risingtheme.com/html/demo-suruchi-v1/suruchi/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 May 2026 10:29:15 GMT -->
</html>