...
<head>
  <meta charset="utf-8">
  <title>New Arrivals - Silai Point</title>
...
.custom__breadcrumb{
    ...
    background:url('/assets/img/banner/Blog_Detailed_KurtaSetGuide_D_revised_11-08-2023-12-37.avif') center center/cover no-repeat;
...
@media(max-width:768px){
    ...
    {{-- Fabrics --}}
    @foreach ($latestFabrics as $fabric)
    <div class="col mb-30">
