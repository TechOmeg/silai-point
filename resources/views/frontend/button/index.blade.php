...
<head>
  <meta charset="utf-8">
  <title>Buttons - Silai Point</title>
...
.custom__breadcrumb{
    ...
    background:url('/assets/img/banner/IMG_7519__85796.jpg') center center/cover no-repeat;
                        ...
                        <div class="shop__sidebar--widget widget__area d-none d-lg-block">
                                      ...
                                      <li class="widget__categories--menu__list">
                                          ...
                                          <label class="widget__categories--menu__label d-flex align-items-center">
                                              ...
                                              <img class="widget__categories--menu__img"
                                                   src="{{ asset('uploads/button_categories/' . $category->image) }}"
                                                   alt="categories-img">
                                              ...
                                              <i class="fa-solid fa-arrow-right widget__categories--menu__arrowdown--icon"></i>
                            ...
                            <div class="single__widget widget__bg">
                                ...
                                <div class="product__grid--inner">
                                    @foreach ($topRatedButtons as $button)
                                    <div class="product__items product__items--grid d-flex align-items-center">
                                        <div class="product__items--grid__thumbnail position__relative">
                                            <a class="product__items--link" href="product-details.html">
                                                <img class="product__items--img product__primary--img" src="{{ asset('uploads/buttons/' . $button->image) }}" alt="product-img">
                                                <img class="product__items--img product__secondary--img" src="{{ asset('uploads/buttons/' . $button->image) }}" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__items--grid__content">
                                            <h3 class="product__items--content__title h4"><a href="product-details.html">{{ $button->name }}</a></h3>
                                            <div class="product__items--price">
                                                <span class="current__price">RS.{{ number_format($button->price, 2) }}</span>
                                                <span class="price__divided"></span>
                                                <span class="old__price">RS.{{ number_format($button->old_price, 2) }}</span>
                                            </div>
                            ...
                            <div class="single__widget widget__bg">
    <h2 class="widget__title h3">Button Brands</h2>

    <ul class="widget__tagcloud">
        <li class="widget__tagcloud--list">
            <a class="widget__tagcloud--link" href="#">Taj Buttons</a>
        </li>

        <li class="widget__tagcloud--list">
            <a class="widget__tagcloud--link" href="#">Diamond Buttons</a>
        </li>

        <li class="widget__tagcloud--list">
            <a class="widget__tagcloud--link" href="#">Pakistan Button House</a>
        </li>

        <li class="widget__tagcloud--list">
            <a class="widget__tagcloud--link" href="#">Royal Buttons</a>
        </li>

        <li class="widget__tagcloud--list">
            <a class="widget__tagcloud--link" href="#">Classic Button Centre</a>
        </li>

        <li class="widget__tagcloud--list">
            <a class="widget__tagcloud--link" href="#">Lucky Buttons</a>
        </li>

        <li class="widget__tagcloud--list">
            <a class="widget__tagcloud--link" href="#">Karachi Button House</a>
        </li>

        <li class="widget__tagcloud--list">
            <a class="widget__tagcloud--link" href="#">Premium Tailor Buttons</a>
        </li>
    </ul>
</div>
                        </div>
        ...
        <ul class="pagination__wrapper d-flex align-items-center justify-content-center">
            ...
            @else
                <li class="pagination__list">
                    <a href="{{ $buttons->previousPageUrl() }}" class="pagination__item--arrow link">
                        <i class="fa-solid fa-angle-left"></i>
                    </a>
                </li>
            @endif
            ...
            {{-- Pagination Numbers --}}
            @for ($i = 1; $i <= $buttons->lastPage(); $i++)
                <li class="pagination__list">
                    <a href="{{ $buttons->url($i) }}"
                       class="pagination__item {{ $buttons->currentPage() == $i ? 'pagination__item--current' : 'link' }}">
                        {{ $i }}
                    </a>
                </li>
            @endfor
            ...
            {{-- Next Page Link --}}
            @if ($buttons->hasMorePages())
                <li class="pagination__list">
                    <a href="{{ $buttons->nextPageUrl() }}" class="pagination__item--arrow link">
