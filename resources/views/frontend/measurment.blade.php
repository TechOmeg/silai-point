...
<section class="measurement-page" measurement-page>
            ...
            <div class="col-lg-8">
                ...
                <div class="measurement-card">
                    ...
                    <p class="measurement-desc">
                        Apni exact measurements enter karein takay aapka custom stitched
                        kameez shalwar perfectly fit ho. Har field carefully fill karein.
                    </p>
                    ...
                    <form action="{{route('measurements.store')}}" method="POST"
                     enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    <div class="measurement-group">
                                        ...
                                        <input type="text"
                                               name="teera"
                                               class="measurement-input"
                                               placeholder="Enter Teera Size">
                                    </div>
                                </div>

                                <div class="col-md-6">
                                    <div class="measurement-group">
                                        <label>Bazu Length</label>
                                        <input type="text"
                                               name="bazu_length"
                                               class="measurement-input"
                                               placeholder="Enter Bazu Length">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="measurement-group">
                                        ...
                                        <input type="text"
                                               name="kameez_length"
                                               class="measurement-input"
                                               placeholder="Enter Kameez Length">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                     <div class="measurement-group">
                                         ...
                                         <select name="silai_type"
                                                 class="measurement-input">
                                 
                                             <option value="single">
                                                 Single Silai - Rs.1999
                                             </option>
                                 
                                             <option value="double">
                                                 Double Silai - Rs.2999
                                             </option>
                        ...
                        <div class="measurement-step">
                            ...
                            <h4>Tailor Instructions</h4>

                            <textarea name="instructions"
                                      class="measurement-textarea"
                                      placeholder="Loose fitting, slim fit, cuff style, extra pocket etc..."></textarea>
        ...
        Pay With Easypaisa
            ...
            <div class="col-lg-4">
                ...
                <div class="measurement-summary">
                    ...
                    <div class="measurement-demo mb-4"> <img src="{{ asset('uploads/demo.png') }}" alt="measurement-guide"> </div>
                    ...
                    <div class="summary-box">
                        ...
                        <p>
                            Inch tape use karein aur body ko relaxed position me rakhein.
                            Measurements zyada tight ya loose na lein.
                        </p>
                    ...
                    <div class="summary-box">
                        ...
                        <p>
                            Agar aapki measurements incorrect hui to fitting issue ho sakta hai.
                            Isliye har measurement carefully enter karein.
                        </p>
                    ...
                    <div class="summary-box">
                        ...
                        <p>
                            Custom stitching order normally 5-7 working days me complete hota hai.
                        </p>
